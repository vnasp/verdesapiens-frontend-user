  ...
  return (
    <main>
      ...
      <section className="p-4 md:p-10 text-lg text-justify relative">
          ...
          <>
            <article>
              <div className="flex flex-col justify-center items-center md:flex-row md:justify-between md:items-start gap-8 mb-10">
                <Image
                  src={getAssetPath(`/icons/${resultados.verdura}.webp`)}
                  height={60}
                  width={60}
            ...
            <div className="flex flex-col items-center mt-4">
              <Image
                src={getAssetPath("/icons/seeding.webp")}
                height={100}
                width={382}
        ...
        <article
          id="consejosSection"
          className="hidden absolute bg-warmGray-200 top-0 left-0 z-10 flex-col items-center p-4 md:p-10"
        >
          <div className="flex flex-col justify-center items-center md:flex-row gap-10 mb-8">
            <Image
              src={getAssetPath("/icons/rotacion.webp")}
              height={150}
              width={150}
          ...
          <div className="flex flex-col justify-center items-center md:flex-row gap-10 mb-8">
            ...
            <Image
              src={getAssetPath("/icons/compatibilidad.webp")}
              height={150}
              width={150}
